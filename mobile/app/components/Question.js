...
const Question = ({
  ...
  <View>
    <View style={styles.containerStyle}>
      ...
      <Text>
        Publication Date: {new Date(questionData.pub_date).toDateString()}{" "}
      </Text>
      <Text
        style={styles.accordionButton}
        onPress={() => toggleAccordion(() => !isAccordionActive)}
      >
        {isAccordionActive ? "Hide" : "Show more"}
      </Text>
    </View>
    <View
      display={isAccordionActive ? "flex" : "none"}
      style={questionData.user.length ? styles.containerStyle : null}
    >
    ...
    <View
      display={isAccordionActive && !questionData.user.length ? "flex" : "none"}
